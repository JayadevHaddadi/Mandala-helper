...
export class Game {
    public bga: Bga<pushfighttestPlayer, pushfighttestGamedatas>;
    private gamedatas: pushfighttestGamedatas;

    private playerTurn: PlayerTurn;

    constructor(bga: Bga<pushfighttestPlayer, pushfighttestGamedatas>) {
        console.log('pushfighttest constructor');
        this.bga = bga;
    ...
    */
    ...
    setup(gamedatas: pushfighttestGamedatas) {
