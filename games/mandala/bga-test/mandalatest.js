...
function (dojo, declare, bgaHelp) {
    return declare("bgagame.mandalatest", [
            ebg.core.gamegui,
        ...
        */
            ...
            switch(areaSplit[1]) {
                case 'mountain':
                    if (this.checkAction('buildMountain',true)) {
                        ...
                        if (!needsConfirm) {
                            this.cleanPlayer();
                            this.ajaxcall("/mandalatest/mandalatest/buildMountain.html", {
                                lock: true,
                                cardId: cardId,
                            ...
                            this.pendingMove = {
                                ...
                                ajaxUrl: "/mandalatest/mandalatest/buildMountain.html",
                ...
                case 'field':
                    if (this.checkAction('growField',true)) {
                        ...
                        if (!needsConfirm && !hasUnselected) {
                            this.cleanPlayer();
                            this.ajaxcall("/mandalatest/mandalatest/growField.html", {
                                lock: true,
                                cardIds: cardIds,
                                fieldId: fieldId
                            }, this, function(result) {});
                            ...
                            this.pendingMove = {
                                ...
                                domWrapperId: domWrapperId,
                                ajaxUrl: "/mandalatest/mandalatest/growField.html",
                ...
                case 'discard':
                    if (this.checkAction('discard',true)) {
                        ...
                        if (!needsConfirm) {
                            this.cleanPlayer();
                            this.ajaxcall("/mandalatest/mandalatest/discard.html", {
                                lock: true,
                                cardIds: cardIds
                            }, this, function(result) {});
                        } else {
                            ...
                            this.pendingMove = {
                                ...
                                domWrapperId: domWrapperId,
                                ajaxUrl: "/mandalatest/mandalatest/discard.html",
        ...
        onConfirmClaim: function(mountain) {
            ...
            if (this.checkAction('claimCards',true)) {
                ...
                this.ajaxcall("/mandalatest/mandalatest/claimCards.html", {
                    lock: true,
                    mountainId: mountain,
