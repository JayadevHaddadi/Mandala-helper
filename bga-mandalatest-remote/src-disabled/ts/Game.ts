...
export class Game {
    public bga: Bga<MandalatestPlayer, MandalatestGamedatas>;
    private gamedatas: MandalatestGamedatas;

    private playerTurn: PlayerTurn;

    constructor(bga: Bga<MandalatestPlayer, MandalatestGamedatas>) {
        console.log('mandalatest constructor');
        this.bga = bga;
    ...
    */
    ...
    setup(gamedatas: MandalatestGamedatas) {
